...
RUN wget -q -O arm-none-eabi-gcc.tar.gz "https://github.com/xpack-dev-tools/arm-none-eabi-gcc-xpack/releases/download/v11.3.1-1.1/xpack-arm-none-eabi-gcc-11.3.1-1.1-linux-x64.tar.gz" \
...
RUN wget -q -O cmake.tar.gz "https://cmake.org/files/v3.26/cmake-3.26.0-linux-x86_64.tar.gz" \
